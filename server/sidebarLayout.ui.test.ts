...
vi.mock("@/_core/hooks/useAuth", () => ({ useAuth: () => ({ user: { id: 1, name: "Responsable Lucepress", email: "contact@lucepress.example", role: "admin" }, logout: vi.fn() }) }));
...
vi.mock("@/components/lucepress-landing.css", () => ({}));
