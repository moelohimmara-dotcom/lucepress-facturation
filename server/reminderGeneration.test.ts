...
const mocks = vi.hoisted(() => ({
  getDocumentById: vi.fn(async () => ({ id: 4, kind: "facture", number: "FAC-2026-0004", clientName: "Bati Guinée", contactName: "Mamadou Diallo", clientEmail: "contact@bati.example", issueDate: "2026-08-01", dueDate: "2026-08-15", balanceDue: 350000 })),
}));
vi.mock("./db", () => ({ getDocumentById: mocks.getDocumentById }));
vi.mock("./_core/llm", () => ({
