...
const state = vi.hoisted(() => ({ navigate: vi.fn(), createDepositInvoice: vi.fn() }));
...
afterEach(() => { cleanup(); state.navigate.mockReset(); state.createDepositInvoice.mockReset(); });
