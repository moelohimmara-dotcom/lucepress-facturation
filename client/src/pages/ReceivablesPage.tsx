...
import { AlertTriangle, ArrowUpRight, CalendarClock, CheckCircle2, CircleDollarSign, ClipboardCheck, Copy, Download, ExternalLink, FileDown, History, Loader2, Mail, Search, ShieldAlert, Sparkles, UserRoundCheck, UsersRound, WalletCards, X } from "lucide-react";
...
type FollowUpInvoice = { id: number; number: string; clientId: number; clientName: string; collectionStatus?: CollectionFollowUpStatus; collectionOwnerId?: number | null };
