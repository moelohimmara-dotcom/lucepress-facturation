...
const filterLabels: Record<"all" | CalendarEventKind, string> = { all: "Toutes", devis: "Devis", relance: "Relances" };
...
export default function CalendarPage() {
  ...
  const events = useMemo(() => buildCalendarEvents(quotes, center?.campaigns ?? []), [quotes, center?.campaigns]);
  ...
  const isLoading = loadingQuotes || loadingCampaigns;
