...
export function AuthShell({ kicker, title, description, children, footerLink }: AuthShellProps) {
  return (
    <div className="relative min-h-screen overflow-hidden bg-background">
      ...
      />
      <div className="relative mx-auto grid min-h-screen w-full max-w-6xl grid-cols-1 items-stretch gap-0 px-4 py-8 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10 lg:py-12">
        {/* Panneau éditorial — la marque */}
        <aside className="relative hidden flex-col justify-between overflow-hidden rounded-[1.6rem] border border-border bg-gradient-to-br from-sidebar to-primary p-8 text-sidebar-foreground lg:flex lg:p-12">
          ...
          <div className="relative z-10 flex flex-col gap-10">
            ...
            <div className="max-w-sm">
              ...
              <h1 className="font-editorial mt-4 text-[2.6rem] font-semibold leading-[1.05] tracking-tight text-sidebar-foreground">
                Vos devis, vos créances,
                <span className="block italic text-sidebar-primary">une seule lumière.</span>
              </h1>
              <p className="mt-5 max-w-xs text-sm leading-7 text-sidebar-foreground/75">
                L'espace sécurisé de {LUCEPRES_PUBLIC_PROFILE.displayName}. Gérez vos documents, vos clients et votre trésorerie depuis un seul endroit.
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center">
          <div className="mx-auto w-full max-w-md">
            ...
            <header className="mb-8">
              ...
              <h2 className="font-editorial mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">{title}</h2>
            ...
            <p className="mt-10 text-center text-xs leading-5 text-muted-foreground/70">
              {LUCEPRES_PUBLIC_PROFILE.legalName} · {LUCEPRES_PUBLIC_PROFILE.location}
              <br />
