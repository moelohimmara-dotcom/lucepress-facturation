...
const FOOTER_COLS = [
  {
    title: "Produit",
    links: [
      { label: "Devis", href: "/login" },
      { label: "Factures", href: "/login" },
      { label: "Créances", href: "/login" },
    ],
  },
  {
    title: "Équipe",
    ...
    <div className="lp">
      <div className="lp-nav-wrap">
        ...
        >
          <a className="lp-brand" href="#top" aria-label={`${LUCEPRES_PUBLIC_PROFILE.displayName} — accueil`}>
            ...
            <span className="lp-brand-text">{LUCEPRES_PUBLIC_PROFILE.displayName}</span>
          </a>
      ...
      <section className="lp-hero" id="top" aria-label="Accueil">
        ...
        <div className="lp-hero-content">
          ...
          <motion.p className="lp-hero-brand" {...fade(0.16)}>
        ...
        <ol className="lp-funnel">
          {FUNNEL.map((step) => (
            <li className="lp-funnel-row" key={step.n}>
              <span className="lp-funnel-n" aria-hidden>{step.n}</span>
      ...
      <footer className="lp-footer">
        <div className="lp-footer-inner">
          <div className="lp-footer-brand">
            <a className="lp-brand lp-brand-footer" href="#top">
              <LucepresMark size="sm" tone="ghost" className="lp-mark" />
              <span className="lp-brand-text">{LUCEPRES_PUBLIC_PROFILE.displayName}</span>
            </a>
            <p>
